...
function transformData(data) {
  data.forEach(el => {
    recipeCard += `<form class='recipe-container' method='post' action='/save-recipe'><h5 class='recipe-id' hidden>${el.id}</h5><br>
    ...
    <button class='btn' type='submit'>Save Recipe</button></form>
    `;
